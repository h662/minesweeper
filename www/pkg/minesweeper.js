...
const MinesweeperFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_minesweeper_free(ptr >>> 0, 1));
...
export class Minesweeper {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        MinesweeperFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_minesweeper_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.minesweeper_new();
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        MinesweeperFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    update() {
        wasm.minesweeper_update(this.__wbg_ptr);
    }
    render() {
        wasm.minesweeper_render(this.__wbg_ptr);
    }
    /**
     * @param {string} mode
     */
    set_mode(mode) {
        ...
        wasm.minesweeper_set_mode(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @returns {string}
     */
    current_mode() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.minesweeper_current_mode(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    restart() {
        wasm.minesweeper_restart(this.__wbg_ptr);
    }
    /**
     * @returns {boolean}
     */
    is_game_over() {
        const ret = wasm.minesweeper_is_game_over(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {boolean}
     */
    is_game_won() {
        const ret = wasm.minesweeper_is_game_won(this.__wbg_ptr);
        return ret !== 0;
    }
}
